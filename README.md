...
<img width="694" height="409" alt="Onglet_environnement" src="https://github.com/user-attachments/assets/77bcd253-08e7-4e6a-99df-bce93b138de9" />

3. Créez un environnement `inf1007` en utilisant la version de python `3.11`
<img width="1001" height="710" alt="create_environment" src="https://github.com/user-attachments/assets/9b9d3e0d-7fc6-4c71-837c-e00fba09a2a7" />
...
<img width="1186" height="775" alt="VS_CODE_Open_Folder" src="https://github.com/user-attachments/assets/8b581436-2b76-40cc-a2eb-0556fd194af5" />

6. Téléchargez l'extension Python de VS Code à partir du menu "extensions" :
...
<img width="481" height="428" alt="create_test_py" src="https://github.com/user-attachments/assets/e7df5026-6365-4292-9025-e412d85f1d91" />
...
print('Hello world !')
```
<img width="687" height="272" alt="copier_coller_hello_world" src="https://github.com/user-attachments/assets/aeccd847-5d86-49eb-aea4-8c18a404334d" />
...
<img width="1392" height="451" alt="inf1007_python_environment" src="https://github.com/user-attachments/assets/a990618d-52a5-4ff6-b05d-ba5afebf0dbf" />
...
<img width="670" height="178" alt="fleche" src="https://github.com/user-attachments/assets/4359515d-ab0f-42bf-9e43-df87e57479d7" />

> Vous devriez voir apparaitre `Hello world !` dans la console en bas de votre fenètre !
<img width="713" height="141" alt="Code_executed_hello_world" src="https://github.com/user-attachments/assets/944f47ea-e3d3-4c6f-82e9-50ce2d4fa371" />
...
<img width="1084" height="438" alt="Github_Classrooms_Accept_Assignment" src="https://github.com/user-attachments/assets/254af7e3-0a78-46b2-bc82-5904185aecfd" />

Puis une fois que vous acceptez, vous devriez recevoir le message suivant :

<img width="743" height="373" alt="Ready_to_go" src="https://github.com/user-attachments/assets/9d58295d-3c0b-4f35-8e4f-7cb158cb5bed" />


Cliquez sur le lien github et vous devriez arriver sur votre propre repository copie du TP0 original.

<img width="1391" height="804" alt="fork" src="https://github.com/user-attachments/assets/fea85bee-8cf5-4cc0-94d3-c0fdc3838d83" />
